...
Features:View all orders (normal and scheduled)
...
JavaScript (ES6+) – Interactive functionality:DOM manipulation and event handling
...
git clone https://github.com/your-username/smart-pre-order-scheduling.gitcd smart-pre-order-scheduling
...
Login: Enter any username/password (demo mode)

Browse: Explore restaurants and cuisines

Order: Choose between Normal or Scheduled delivery

Schedule: For scheduled orders, select date and time

Track: View all orders in the dashboard
...
Built with ❤️ for food lovers who plan ahead │── assets/
